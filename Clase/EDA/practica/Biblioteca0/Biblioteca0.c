        ...
        */
        ...
        switch(OpcionMenu) {
            case 1:     //Gestión de Fichas de Libros
                Wauxiliar=newwin(12,76,5,2);
                DibujarLibro(Wauxiliar);
                wrefresh(Wauxiliar);
            ...
            case 24:    //Descartar fichero
                Wauxiliar=newwin(5,76,5,2);
                DibujarGestionFichero(Wauxiliar);
                wrefresh(Wauxiliar);
                VentanaError("Opcion no implementada");
                delwin(Wauxiliar);
                break;
            ...
            case 5:     //Ver Estadísticas
                Wauxiliar=newwin(14,76,3,2);
                DibujarEstadisticas(Wauxiliar);
                wrefresh(Wauxiliar);
                VentanaError("Opcion no implementada");
                delwin(Wauxiliar);
                break;
